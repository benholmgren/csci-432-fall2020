...
\begin{enumerate}
	...
	\item
		...
		every possible combination of the indices of $X$, so that we gain every possible ordering of $X$,
		and by inputting every combination into \textsc{SpecificSubsetSum}, we then gain every possible
		subset of $X$ which sums to $T$.
		Then we compute
